 ...
 */
@WebServlet(name = "AltaProfesor", urlPatterns = {"/AltaProfesor"})
...
//                cuando no tiene los permisos de edicion de examen lo redirijo al listado de examenes con un mensaje
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String nombre = request.getParameter("txtNombreProfesor");
            String apellido = request.getParameter("txtApellidoProfesor");
            int CE = Integer.parseInt(request.getParameter("txtCodEstadistico"));
            int dni = Integer.parseInt(request.getParameter("txtDni"));
            int idGrado = Integer.parseInt(request.getParameter("cmbGrado"));

            Profesor p = new Profesor(0, idGrado, nombre, apellido, CE, dni, null);
