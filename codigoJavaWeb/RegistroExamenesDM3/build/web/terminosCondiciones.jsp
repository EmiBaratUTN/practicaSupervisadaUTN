<%-- 
    ...
    Created on : Jul 7, 2021, 6:14:48 PM
    ...
    <body>
        ...
        <div class="container">
            ...
            <p>
                ...
                de Privacidad correspondiente de "Sistema de gestion de examenes de EduFis". Al acceder y utilizar el Servicio, usted expresa
                ...
                Privacidad, no utilice el Servicio.</p>
            <p>
                ...
                términos y condiciones que a continuación se detallan:</p>
            
            <h6>Operaciones habilitadas.</h6>
            <p>    Las operaciones habilitadas son aquellas que estarán disponibles para los clientes,
                ...
                entre otras, sin que pueda entenderse taxativamente las que se indican a continuación:</p>
            <ul>
                <li>Registro de alumnos</li>
                <li>Registro de exámenes de un alumno</li>
                <li>Registro de peso de un alumno</li>
                <li>Alta de profesores</li>
                <li>Alta de usuarios del sistema</li>
                <li>Consulta de listrado de alumnos</li>
                <li>Consulta de listrado de exámenes</li>
                <li>Consulta de listrado de profesores</li>
                <li>Consulta de listrado de usuarios</li>
                <li>Consulta de listrado de registros de peso</li>
                <li>Visualizar gráficos estadísticos</li>
            </ul>
            <p>
                En ningún caso debe entenderse que la solicitud de un producto o servicio implica
                obligación alguna para el Acceso y uso del Servicio.</p>
            <p>
                Para operar el Servicio se requerirá siempre que se trate de efectivos de Gendarmería Nacional Argentina, quienes
                podrán acceder mediante cualquier dispositivo con conexión a la Red Internet. El cliente
                deberá proporcionar los datos necesarios y las credenciales de acceso al sistema
                en la forma que le sea requerida. La clave personal y todo o cualquier otro mecanismo adicional de
                autenticación personal provisto por la Compania tiene el carácter de secreto e intransferible,
                y por lo tanto asumo las consecuencias de su divulgación a terceros, liberando a la Compania
                de toda responsabilidad que de ello se derive. En ningún caso la Compania requerirá que le
                suministre la totalidad de los datos, ni enviara mail requiriendo información personal
                alguna.</p>
            <p>
            <h6>Costo del Servicio.</h6>
                La empresa Emiliano Inc. podrá cobrar comisiones por el mantenimiento y/o uso de este
            ...
            <p>
                ...
                relación contractual con empresa Emiliano Inc., o de los presentes Términos y Condiciones, la Compania
                podrá decretar la caducidad del presente Servicio en forma inmediata, sin que
                ello genere derecho a indemnización o compensación alguna. La Compania podrá dejar
                sin efecto la relación que surja de la presente, con un preaviso mínimo de 60 días, sin
                otra responsabilidad.</p>
            
            <h6>Validez de operaciones y notificaciones.</h6>
            <p>    Los registros emitidos por la app serán prueba suficiente de las operaciones cursadas
            ...
            <h6>Privacidad de la información</h6>
             <p>    Para utilizar los Servicios ofrecidos por Emiliano Inc., los Usuarios deberán facilitar
